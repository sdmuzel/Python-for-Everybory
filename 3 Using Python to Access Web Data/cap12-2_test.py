...
# Actual data: http://py4e-data.dr-chuck.net/comments_1006555.html (Sum ends with 67)
...
html=urllib.request.urlopen('http://py4e-data.dr-chuck.net/comments_42.html').read() ## link for test
