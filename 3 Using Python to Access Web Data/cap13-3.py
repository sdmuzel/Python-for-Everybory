...
#the address= parameter that is properly URL encoded using the urllib.parse.urlencode() function as shown in http://www.py4e.com/code3/geojson.py
...
# -Turn In
#Plase run your program to find the place_id for this location:
#- Penn State University

# Make sure to enter the name and case exactly as above and enter the place_id and your Python code below.
# Hint: The first seven characters of the place_id are "ChIJkQJ ..."
...
while True:
    ...
    url = serviceurl.strip() + url.strip()
